                ...
                <div class = "card-body">
                  ...
                  <form method = "POST" class = "my-login-validation" novalidate = "">
                    ...
                    <div class = "form-group">
                      ...
                      <input id = "captcha" class = "form-control" autocomplete = "off" required v-model = "captcha">
                    ...
                    <div class = "form-group" v-show = "isRegister">
                      ...
                      <input v-model = "nickname" id = "name" type = "text" class = "form-control" required autofocus>
                    ...
                    <div class = "form-group">
                      <div class = "custom-checkbox custom-control">
                        <input type = "checkbox" v-model = "isAgree" id = "agree" class = "custom-control-input"
                               required = "required">
                        <label for = "agree" class = "custom-control-label">我同意 <a
                          href = "https://st.music.163.com/official-terms/service">《服务条款》</a></label>
    ...
    methods: {
      ...
      goForget() {
        if (!this.captcha) {
          ...
          register({ account: this.phone, password: this.password, captcha: this.captcha }).then(res => {
            // console.log(res);
