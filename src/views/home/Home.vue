<template>
  <div class="home">
    ...
    >
      ...
      />
      <HomeTypeList
        :type-list="typeList[current_index].list"
  ...
  methods: {
    ...
    isLogin(res) {
      ...
      if (res.toString().indexOf("301") !== -1) {
        ...
        userDetail(res.data.data.profile.userId)
          .then(res => {
